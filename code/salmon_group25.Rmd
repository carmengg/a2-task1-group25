...
- For adult steelhead salmons we can observe clear seasonaility of the weekly average passage in every year. 
The  average count increases from December to May/June, then decreases until August/September and remains in less than 100 average crossings from until December.

- Both groups of coho salmons have the same seasonality in weekly average passage. Coho salmons seem to only use the fish ladder from Aug to December, with crossings increasing from August and peaking in September. 

- Average weekly crossings of adult coho salmons have increased from 2001 to 2010, while passage of adult steelhead has decreased in the same period. 
